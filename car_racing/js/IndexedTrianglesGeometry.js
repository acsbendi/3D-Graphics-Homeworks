"use strict";
const IndexedTrianglesGeometry = function(gl, meshDescriptor) {
  this.gl = gl;
  ...
  gl.bufferData(gl.ARRAY_BUFFER, 
    new Float32Array(
      meshDescriptor.texturecoords[0]
    ), 
    gl.STATIC_DRAW);
 
  const indices = [].concat.apply([], meshDescriptor.faces);
